...
export default function GraphPage() {
  ...
  const handleQuery = async (question: string) => {
    ...
    try {
      ...
      setResults({ visible: true, title: 'AI response', type: 'query', items: [{ title: 'Answer', snippet: data.answer, source: '' }], query: question });
    } catch (err) {
    ...
    <div className={`${styles.root} ${settings.floatingMode ? styles.floatMode : ''}`}>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.toolbar}>
          ...
          <button className={styles.toolbarBtn} onClick={() => { /* loadSearchResults stub */ }}>
            Search results
          </button>
